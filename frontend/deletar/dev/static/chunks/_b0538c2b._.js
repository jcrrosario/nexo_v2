...
function DepartamentosPage() {
    ...
    async function carregar() {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get('/entity/departamentos');
    ...
    function salvar() {
        if (editando) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].put(`/entity/departamentos/${form.dpto_id}`, form);
        } else {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post('/entity/departamentos', form);
        }
        setOpen(false);
        carregar();
    }
    function excluir(d) {
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].put(`/entity/departamentos/${d.dpto_id}/excluir`, {});
        carregar();
    }
    function gerarPDF() {
    ...
    function gerarExcel() {
        const ws = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["utils"].json_to_sheet(dados);
...
_s(DepartamentosPage, "vTqsSIbPYzhLbGmZGNT8Ea4TYJA=");
...
//# sourceMappingURL=_b0538c2b._.js.map